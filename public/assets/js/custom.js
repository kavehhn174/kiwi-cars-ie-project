(function ($) {
  ...
  $(window)
    .scroll(function () {
      ...
      if (scroll >= box - header) {
        $('header')
          .addClass('background-header');
      } else {
        $('header')
          .removeClass('background-header');
      }
    });
  ...
  $(document)
    .on('click', '.naccs .menu div', function () {
        ...
        if (thisItemParent.hasClass('has-sub')) {
          ...
          if (submenu.is(':visible')) {
            ...
            if (thisItemParentSiblingsWithDrop.length === 0) {
              thisItemParent.find('.sub-menu')
                .slideUp(400, 'easeInOutQuad', function () {
                  submenu.slideDown(250, 'easeInOutQuad');
                });
            } else {
              thisItemParent.siblings()
